...
const SEO: React.FC<SEOProps> = ({
  title = "Sportivex",
  description = "Sportivex: Pioneering smart engineering solutions with textile sensors for sports, safety, and performance monitoring.",
  type = "website",
  name = "Sportivex",
  ...
  const currentUrl = `https://sportivex.com${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith("http")
    ? imageUrl
    : `https://sportivex.com${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    "@type": "Organization",
    name: "Sportivex",
    url: "https://sportivex.com",
    logo: "https://sportivex.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png",
    description: "Pioneering smart engineering solutions with textile sensors",
    contactPoint: {
      "@type": "ContactPoint",
      contactType: "customer service",
      email: "info@sportivex.com",
    },
    sameAs: [
      "https://www.linkedin.com/company/sportivex",
      "https://twitter.com/sportivex",
    ],
  };
    ...
    isBlogPost && publishDate
      ? {
          ...
          publisher: {
            ...
            logo: {
              "@type": "ImageObject",
              url: "https://sportivex.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png",
              width: 512,
              height: 512,
            },
            url: "https://sportivex.com",
  ...
  return (
    <>
      ...
      <meta property="og:site_name" content="Sportivex" />
      ...
      {isBlogPost && (
        <meta property="article:publisher" content="https://sportivex.com" />
      )}
      ...
      <meta name="twitter:site" content="@sportivex" />
      <meta name="twitter:creator" content="@sportivex" />
