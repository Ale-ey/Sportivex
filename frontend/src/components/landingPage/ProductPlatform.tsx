    ...
    <div className="w-full relative">
      ...
      >
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-4xl">
          7+ years invested in our comprehensive IoT development platform. We
          enable brands to own their complete product experience while WRLDS
          handles the technical complexity of hardware, software, and production
          at scale.
        </p>
      </motion.div>
        ...
        >
          <div className="bg-gray-200 rounded-xl p-4 sm:p-6">
            ...
            <p className="text-xs sm:text-sm text-center mt-4 sm:mt-6">
              Smart hardware devices with integrated
              <br />
        ...
        >
          <div className="bg-gray-200 rounded-xl p-4 sm:p-6">
            ...
            <p className="text-xs sm:text-sm text-center mt-4 sm:mt-6">
              ...
              <br />
              for rapid IoT solution deployment
            </p>
          </div>
        </motion.div>
          ...
          <div className="bg-gray-200 rounded-xl p-4 sm:p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  icon: (
                    <FileText className="text-black w-4 h-4 sm:w-5 sm:h-5" />
                  ),
