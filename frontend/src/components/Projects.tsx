      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">
            See how we've turned ambitious product visions into market-ready
            solutions generating real revenue across multiple industries.
          </p>
          <div className="flex md:hidden items-center justify-center mt-4 animate-pulse-slow">
