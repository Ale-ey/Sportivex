          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              >
                ...
                <p className="text-gray-600 mb-8 text-base max-w-3xl">
                  At WRLDS, we've developed a systematic approach to creating
                  smart textile solutions that combines technical innovation
                  with practical implementation. Our comprehensive development
                  process ensures that every project moves efficiently from
                  ...
                  {[
                    {
                      ...
                      description:
                        "We begin with thorough market research and requirements gathering to understand your specific needs and opportunities.",
                    },
                    {
                      title: "Design & Prototyping",
                      icon: <Code className="w-5 h-5 text-gray-700" />,
                      description:
                        "Our teams create initial designs and functional prototypes that allow for early testing and iteration.",
                    },
                    {
                      title: "Development & Testing",
                      icon: <FileText className="w-5 h-5 text-gray-700" />,
                      description:
                        "We rigorously develop and test all components to ensure they meet performance and reliability standards.",
                    },
                  ].map((phase, i) => (
                    <motion.div
                      key={phase.title}
